  ...
  return (
    ...
    <div className="bg-[#4daaa9] min-h-screen ">
        <div className="flex  flex-col items-center  ">
          ...
          <p className=" mt-28 mx-10 sm:mx-16 lg:mx-20 text-lg text-[#d8edf3] text-center font-semibold max-w-4xl animate-slidein ">
          ...
          <p className="mt-10 mx-10  sm:mx-16 lg:mx-20 text-lg text-[#d8edf3] text-center font-bold max-w-4xl animate-slidein">
          ...
          <div className="mt-10  mb-10 flex justify-center animate-slidein ">
            <Link
              to='/stories'
              className=" flex  py-2 bg-[#4d7daa] text-white rounded-md w-40 h-10 border text-center hover:bg-[#8db6c1] font-roboto"
            >
              <span className="ml-2 font-light">Start the Journey </span>
